...
<#if userLogin?has_content>
    <#assign appMax = Static["org.apache.ofbiz.base.util.UtilProperties"].getPropertyAsInteger("mandara", "appMax", 8)/>
    <#assign alreadySelected = false>
<div id="main-navigation-bar">
    <div id="main-nav-bar-left">
        <div id="company-logo"></div>
        <#--<a id="homeButton" href="<@ofbizUrl>HomeMenu</@ofbizUrl>"><img id="homeButtonImage" src="/mandara/images/home.svg" alt="Home"></a>-->
        <ul id="app-bar-list">
            <#assign appCount = 0>
    ...
    <div class="container-more-app">
        ...
        <div id="main-nav-bar-right">
            <#include "component://mandara/template/includes/Avatar.ftl"/>
        </div>
