...
<body>
<div class='h3'><strong>Put the name of the Datasource in the EntityEngine.xml to induce from:</b></div>
...
It's the datasource name. It doesn't need to be associated with a
 delegator, just defined in entityengine.xml.<br/>
   <strong> Use the browser to view the source and see the entities that were created.</b>
