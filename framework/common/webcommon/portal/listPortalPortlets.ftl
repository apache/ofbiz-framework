...
<div class="screenlet">
  <div class="screenlet-title-bar">
    <ul>
      ...
      <li><a href="<@ofbizUrl>dashboard?portalPageId=${parameters.portalPageId}&amp;configurePortalPage=true</@ofbizUrl>">${uiLabelMap.CommonCancel}</a></li>
    </ul>
    <br class="clear"/>
  </div>
          ...
          <td>
            <table>
              <tr>
                <td>
                  <div class="h2">
                    <a href="<@ofbizUrl>createPortalPagePortlet?portalPortletId=${portalPortlet.portalPortletId}&amp;portalPageId=${parameters.portalPageId}&amp;configurePortalPage=true</@ofbizUrl>">${portalPortlet.portletName}</a>
                  </div>
                  <div class="tabletext">
