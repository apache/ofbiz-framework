...
public class VariantEvents {
    ...
    public static String quickAddChosenVariant(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            errMsg = UtilPropertiesRuntime.getMessage(RESOURCE, "variantevents.featureTypeSize_not_number", messageMap, UtilHttp.getLocale(request));
            request.setAttribute("_ERROR_MESSAGE_", errMsg);
            return "error";
        }
        ...
        try {
            ...
            try {
                ...
                if (product == null) {
                    ...
                    errMsg = UtilPropertiesRuntime.getMessage(RESOURCE, "variantevents.product_not_found_with_ID", messageMap,
                            UtilHttp.getLocale(request));
                ...
                for (int i = 0; i < featureTypeSize; i++) {
                    ...
                    if (productFeatureId == null) {
                        ...
                        errMsg = UtilPropertiesRuntime.getMessage(RESOURCE, "variantevents.productFeatureId_for_feature_type_number_not_found",
                ...
                errMsg = UtilPropertiesRuntime.getMessage(RESOURCE, "variantevents.entity_error_quick_add_variant_data", messageMap,
                        UtilHttp.getLocale(request));
                TransactionUtil.rollback(beganTransacton, errMsg, null);
            ...
            Map<String, String> messageMap = UtilMisc.toMap("errMessage", e.toString());
            errMsg = UtilPropertiesRuntime.getMessage(RESOURCE, "variantevents.transaction_error_quick_add_variant_data", messageMap,
                    UtilHttp.getLocale(request));
            request.setAttribute("_ERROR_MESSAGE_", errMsg);
            return "error";
        }
        ...
        String sucMsg = UtilPropertiesRuntime.getMessage(RESOURCE, "variantevents.successfully_created_variant_product_with_id", messageMap,
                UtilHttp.getLocale(request));
