...
class ShoppingCartTests extends OFBizTestCase {
    ...
    Map createShoppinCartAndOrder(GenericValue userLogin, Locale locale) {
        ...
        shoppingCart.addPaymentAmount('CREDIT_CARD', new BigDecimal('49.26'))
        shoppingCart.setOrderPartyId('DemoCustomer')

        int itemIndex = shoppingCart.addItemToEnd('GZ-2644', new BigDecimal('0'), new BigDecimal('5'), new BigDecimal('38.4'), (HashMap) null, (HashMap) null, 'DemoCatalog', 'PRODUCT_ORDER_ITEM', dispatcher, false, true, true, true)
        def cartItem = shoppingCart.findCartItem(itemIndex)
        shoppingCart.setItemShipGroupQty(cartItem, new BigDecimal('5'), 0)
        ...
        orderAdjustmentPromotion.amount = new BigDecimal('-3.84')
        ...
        orderAdjustmentShipping.amount = new BigDecimal('12.10')
        ...
        orderAdjustmentSalesTax.amount = new BigDecimal('1.824')
        orderAdjustmentSalesTax.sourcePercentage = new BigDecimal('0.100000')
        ...
        orderAdjustmentSalesTax.taxAuthPartyId = 'UT_TAXMAN'
        orderAdjustmentSalesTax.overrideGlAccountId = '224153'
        orderAdjustmentSalesTax.comments = 'Utah State Sales Tax'
        ...
        orderAdjustmentSalesTax1.amount = new BigDecimal('0.039')
        orderAdjustmentSalesTax1.sourcePercentage = new BigDecimal('0.100000')
        ...
        orderAdjustmentSalesTax1.taxAuthPartyId = 'UT_UTAH_TAXMAN'
        orderAdjustmentSalesTax1.overrideGlAccountId = '224153'
        orderAdjustmentSalesTax1.comments = 'Utah County, Utah Sales Tax'
        ...
        orderAdjustmentSalesTax2.amount = new BigDecimal('0.384')
        orderAdjustmentSalesTax2.sourcePercentage = new BigDecimal('1')
        ...
        orderAdjustmentSalesTax2.taxAuthPartyId = '_NA_'
        orderAdjustmentSalesTax2.overrideGlAccountId = '224000'
        orderAdjustmentSalesTax2.comments = '1% OFB _NA_ Tax'
        ...
        shoppingCart.makeAllShipGroupInfos(dispatcher)
    ...
    void testCreateOrderRentalProduct() {
        ...
        shoppingCart.addOrIncreaseItem('RentalShip', null, BigDecimal.ONE, nextDate, new BigDecimal('3'), new BigDecimal('1'), null, null, null, null, null, null, 'DemoCatalog', null, 'RENTAL_ORDER_ITEM', null, null, dispatcher)
    ...
    void testCreateOrderServiceProduct() {
        ...
        shoppingCart.addOrIncreaseItem('SV-1001', null, BigDecimal.ONE, null, null, null, null, null, null, null, null, null, 'DemoCatalog', null, null, null, null, dispatcher)
        shoppingCart.setDefaultCheckoutOptions(dispatcher)
    ...
    void testLoadCartFromQuote() {
        ...
        Map createQuoteItemMap = [
                ...
                quoteUnitPrice: new BigDecimal('15.00')
        ]
    ...
    void testCreateOrderConfigurableServiceProduct() {
        ...
        shoppingCart.addOrIncreaseItem('CFSV1001', null, BigDecimal.ONE, null, null, null, null, null, null, null, null, null, 'DemoCatalog', configWrapper, null, null, null, dispatcher)
    ...
    void testOrderMoveItemBetweenShipGoups() {
        ...
        GenericValue orderItemShipGroupAssoc1 = from('OrderItemShipGroupAssoc').where('orderId', orderId, 'orderItemSeqId', orderItem.orderItemSeqId, 'shipGroupSeqId', '00001').queryOne()
        assert orderItemShipGroupAssoc1.quantity == new BigDecimal('3')

        GenericValue orderItemShipGroupAssoc2 = from('OrderItemShipGroupAssoc').where('orderId', orderId, 'orderItemSeqId', orderItem.orderItemSeqId, 'shipGroupSeqId', '00002').queryOne()
        assert orderItemShipGroupAssoc2.quantity == new BigDecimal('2')

        dispatcher.runSync('deleteOrderItemShipGroupAssoc', [userLogin: userLogin, orderId: orderId, orderItemSeqId: orderItem.orderItemSeqId, shipGroupSeqId: '00002'])
