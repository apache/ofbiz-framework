...
public final class UtilDateTime {
    ...
    /**
     * Makes a time String in the format HH:MM:SS from a separate ints for hour, minute, and second. If the seconds are 0, then the output is in
     * HH:MM.
     *
     * @param hour   The hour int
     * @param minute The minute int
    ...
    /**
     * Returns a copy of {@code date} that cannot be modified. Attempts to modify the returned date will result in an
