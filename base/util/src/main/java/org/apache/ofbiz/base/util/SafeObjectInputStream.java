...
public final class SafeObjectInputStream extends ObjectInputStream {
    ...
    public SafeObjectInputStream(InputStream in) throws IOException {
        super(in);
        String allowListProp = UtilProperties.getPropertyValue("SafeObjectInputStream", "allowList", "");
    ...
    protected Class<?> resolveClass(ObjectStreamClass classDesc) throws IOException, ClassNotFoundException {
        ...
        // DenyList
        String rejectedObjectsProp = UtilProperties.getPropertyValue("security", "denyList", "");
