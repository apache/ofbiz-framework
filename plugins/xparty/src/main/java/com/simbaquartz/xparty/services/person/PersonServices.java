...
public class PersonServices {
  ...
  public static Person getPersonDetails(
    ...
    try {
        ...
        if (ServiceUtil.isSuccess(organizationDetails)) {
          ...
          if (UtilValidate.isNotEmpty(orgPartyGroup)) {
            ...
            Map<String, Object> slackConnectedResp =
                dispatcher.runSync(
                    "checkIfSlackConnected",
                    UtilMisc.toMap("userLogin", userLogin, "accountPartyId", orgPartyId));
      ...
      for (Map partyAttribute :
          org.apache.commons.collections4.CollectionUtils.emptyIfNull(partyAttributes)) {
