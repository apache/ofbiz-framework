...
public Map getEmployeePersons() {
    ...
    relatedParties.each { String relatedPartyId ->
        if (!relatedPartyId.equals(parameters.partyGroupPartyId)) {
//ignore party entries with parameters.partyGroupPartyId as the response includes the partyIdFrom as well
