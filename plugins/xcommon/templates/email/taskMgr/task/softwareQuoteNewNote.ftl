                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            ...
                                            <td width="auto" align="left" valign="top" rowspan="1" colspan="1" style="padding-top:10px">
                                                ...
                                                <#assign partyName = Static["com.fidelissd.fsdParty.party.FsdPartyHelper"].getPartyName(delegator, createdByPartyId)>
                                                    <span><a style="text-decoration:none;color:#0078d7;font-weight:bold;opacity:1!important">${partyName!}</a> added a note to Quote # ${quoteId!}</span>
                                                </div>
                                                <div style="font-family:Helvetica Neue,Helvetica,Arial,Verdana,sans-serif;color:#172b4d;font-size:20px;line-height:24px;text-align:left;font-weight:bold;margin-bottom:10px">
                                                    <span>
                                                        <a style="text-decoration:none;color:#172b4d;opacity:1!important">${quoteName!}</a>
                                                    </span>
                                                </div>
                                                <div style="font-family:Helvetica Neue,Helvetica,Arial,Verdana,sans-serif;color:#172b4d;text-align:left;margin-bottom:30px;">
                                                ${StringUtil.wrapString(noteInfo!)}
                                                </div>
                                                <div style="margin-bottom:30px">
                                                    <a href="https://sellercentral-v2.web.app/project/quote/edit/${quoteId}"  style="font-size:16px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Noto Sans','Ubuntu','Droid Sans','Helvetica Neue',sans-serif;font-weight:none;color:#ffffff;text-decoration:none;background-color:#0078d7;border-top:11px solid #0078d7;border-bottom:11px solid #0078d7;border-left:20px solid #0078d7;border-right:20px solid #0078d7;border-radius:5px;display:inline-block">View Quote</a>
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                                                ...
                                                <table border="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            style="padding:0 0 12px 0;text-align:center">
                                                            <p style="padding:0;margin:0;color:#6a6c6d;font-weight:400;font-size:12px;line-height:1.333">
                                                                Copyright &copy; 2013-${nowTimestamp?string("yyyy")} Simbaquartz.
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </td>
