                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="90%">
                            <tr>
                                <td align="center"
                                    ...
                                    <label style="color:#3b73af;">${modifiedByPartyName!}</label> <strong>updated</strong>&nbsp;<label style="color:#3b73af;">${taskType!}&nbsp;${taskId!}</label></td>
                            </tr>
                ...
                <tr style="background-color: white">
                    <td style="padding-left: 20px;font-family: Helvetica, Arial, Verdana, sans-serif; font-size: 15px;" valign="top">
                        <table width="100%" style="">
                            ...
                            <#if linkCustomer??>
                                <tr>
                                    <td style="width:20%;padding: 10px 0;font-family: Helvetica, Arial, Verdana, sans-serif; font-size: 15px;">
                                        Link Customer :
                                    </td>
                                    <td style="padding: 10px 0;text-align:left;font-family: Helvetica, Arial, Verdana, sans-serif; font-size: 12px;">
                                        <span>${linkCustomer!}</span>
                                    </td>
                                </tr>
                            </#if>
                            <#if modifiedByPartyName??>
                                <tr>
                                    <td style="width:100px;padding: 5px 0;font-family: Helvetica, Arial, Verdana, sans-serif; font-size: 15px;">
                                        Updated By :
                                    </td>
                                    <td style="padding: 5px 0;text-align:left;font-family: Helvetica, Arial, Verdana, sans-serif; font-size: 12px;">
                                        <span>${modifiedByPartyName!}</span>
                                    </td>
                                </tr>
                            </#if>
                            ...
                            <#--<#if createdByUserLoginName??>-->
                                <#--<tr>-->
                                    <#--<td style="width:100px;padding: 5px 0;font-family: Helvetica, Arial, Verdana, sans-serif; font-size: 15px;">-->
                                        <#--Created By User Login :-->
                                    <#--</td>-->
                                    <#--<td style="padding: 5px 0;text-align:left;font-family: Helvetica, Arial, Verdana, sans-serif; font-size: 12px;">-->
                                    <#--${createdByUserLoginName!}-->
                                    <#--</td>-->
                                <#--</tr>-->
                            <#--</#if>-->
