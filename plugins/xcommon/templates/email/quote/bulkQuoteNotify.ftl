                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td width="auto" align="left" valign="top" rowspan="1" colspan="1" style="padding-top:10px">
                                                ...
                                                Bulk Quote operation has been completed that was initiated by you. Please see the following bulk quote operation details:
                                                ...
                                                <div style="padding-top: 10px;">
                                                    ...
                                                    <div>
                                                        <table border="0" cellspacing="0"
                                                            ...
                                                            <#if allBulkQuotes?? && (allBulkQuotes?size>0)>
                                                                <#list allBulkQuotes as newQuote>
                                                                    <tr style="">
