                        ...
                        <table border="0"
                            ...
                            <tr >
                                <td bgcolor="#fff"
                                    ...
                                    <div>Hello Team,</div>
                                    <div>New 850 EDI file was received, has been parsed, and ${quoteIds!?size} quotes has been created.</div>
                                    <div>Find below list of Quotes created:</div>

                                    <#list quoteIds as quoteId>
                                        ${quoteId_index + 1}. ${quoteId} <br/>
                                    </#list>

                                    <br/>
                                    <div><b>Please review the Quotes and send PO Acknowledgment (855) EDI at the earliest </b></div>
                            ...
                            <tr >
                                <td bgcolor="#fff"
                                    ...
                                    EDI File name: ${ediFileName!}<br/>
                                    Find below the content of the 850 EDI content: <br/><br/>
