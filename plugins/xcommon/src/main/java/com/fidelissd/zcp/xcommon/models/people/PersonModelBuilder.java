...
import static com.fidelissd.zcp.xcommon.models.PhoneModelBuilder.preparePhoneModel;

import com.fidelissd.zcp.xcommon.collections.FastList;
import com.fidelissd.zcp.xcommon.models.*;
import com.fidelissd.zcp.xcommon.models.LinkedInAddress;
import com.fidelissd.zcp.xcommon.models.LinkedInAddressModelBuilder;
  ...
  public static Person build(Map personMap) {
    ...
    if (UtilValidate.isNotEmpty(personMap)
      ...
      if (UtilValidate.isNotEmpty(phoneNumbers)) {
        List<Phone> phones = PhoneModelBuilder.preparePhoneModel(phoneNumbers);
