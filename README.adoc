...
//image:https://sonarcloud.io/api/project_badges/measure?project=apache_ofbiz-framework%26metric=alert_status[link=https://sonarcloud.io/dashboard?id=apache_ofbiz-framework]
